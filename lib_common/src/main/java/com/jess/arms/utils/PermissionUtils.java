...
public class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(AppManager.getAppManager().getApplication());
    }
    ...
    public static boolean isGranted(Context context, final String... permissions) {
        for (String permission : permissions) {
            if (!isPermissonGranted(context, permission)) {
                return false;
            }
        }
        return true;
    ...
    private static boolean isPermissonGranted(Context context, final String permission) {
