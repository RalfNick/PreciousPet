...
public class ToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(getApplication().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(getApplication().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                final Toast toast = Toast.makeText(AppManager.getAppManager().getTopActivity(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                final Toast toast = new Toast(AppManager.getAppManager().getTopActivity());
                sWeakToast = new WeakReference<>(toast);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) getApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
