package com.ralf.www.module_chat.db;
...
import com.ralf.www.module_chat.domain.RobotUser;
...
public class ChatDBManager {
    ...
    private ChatDBManager(){
        dbHelper = DbOpenHelper.getInstance(AppManager.getAppManager().getApplication());
    }
