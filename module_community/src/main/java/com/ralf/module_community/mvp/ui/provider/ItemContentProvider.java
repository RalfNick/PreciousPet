...
import com.ralf.pet_provider.widget.player.BitmapIconEffect;
import com.ralf.pet_provider.widget.player.GSYVideoGLViewCustomRender;
...
public class ItemContentProvider extends BaseItemProvider<AdapterMultiItemEntity, BaseViewHolder> {
    ...
    private static final String TAG = ItemCommentProvider.class.getSimpleName();
    /**
     * 图片的路径
     */
