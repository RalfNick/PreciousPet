...
import com.ralf.module_login_register.dg.component.DaggerRegisterComponent;
import com.ralf.module_login_register.dg.module.RegisterModule;
import com.ralf.module_login_register.mvp.contact.RegisterContact;
import com.ralf.module_login_register.mvp.presenter.RegisterPresenter;
 ...
 * @author wanglixin
 */
@Route(path = RouterConfig.LoginRegisterModule.REGISTER_PATH)
public class RegisterActivity extends BaseSwipeBackActivity<RegisterPresenter> implements RegisterContact.View {
    ...
    public void jumpToUserSettingPage(String phone, String passWord, String toastMsg) {
        ARouter.getInstance()
                .build(RouterConfig.LoginRegisterModule.REGISTER_USER_PATH)
                .withString(RouterConfig.LoginRegisterModule.KEY_USER_PHONE, phone)
                .withString(RouterConfig.LoginRegisterModule.KEY_USER_PASSWORD, passWord)
                .navigation();
    ...
    private class MyClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            ARouter.getInstance()
                    ...
                    .withString(RouterConfig.LoginRegisterModule.KEY_USER_PROTOCOL_URL, mUrl)
                    .withString(RouterConfig.LoginRegisterModule.KEY_USER_PROTOCOL_TITLE, mTitle)
                    .navigation();
        }
    }
}
