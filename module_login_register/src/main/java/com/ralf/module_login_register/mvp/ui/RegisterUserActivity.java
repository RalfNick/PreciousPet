...
import com.ralf.module_login_register.dg.component.DaggerRegisterUserComponent;
import com.ralf.module_login_register.mvp.contact.RegisterUserContact;
import com.ralf.module_login_register.mvp.presenter.RegisterUserPresenter;
 ...
 **/
@Route(path = RouterConfig.LoginRegisterModule.REGISTER_USER_PATH)
public class RegisterUserActivity extends BaseActivity<RegisterUserPresenter>
    ...
    @Autowired(name = RouterConfig.LoginRegisterModule.KEY_USER_PHONE)
    String mPhone;

    @Autowired(name = RouterConfig.LoginRegisterModule.KEY_USER_PASSWORD)
    String mPassWord;
