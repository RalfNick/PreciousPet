 ...
 **/
public class NewsImportantAdapter extends BaseQuickAdapter<NewsEntity, BaseViewHolder> {

    public NewsImportantAdapter(int layoutResId, @Nullable List<NewsEntity> data) {
