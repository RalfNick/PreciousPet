package com.ralf.pet_provider.util.device_util;
...
public class ScreenUtils {
    ...
    private Bitmap createSnapshot(View view) {
        ...
        try {
            ...
            screenShot = (Bitmap) method.invoke(view, Bitmap.Config.ARGB_8888, getApplication().getResources().getColor(R.color.white), false);
