...
public final class SpUtil {
    ...
    protected static final String DEFAULT_FILE = "precious_pet";
    ...
    public static SpUtil getInstance(String spName, final int mode) {
        if (isSpace(spName)) spName = DEFAULT_FILE;
    ...
    private SpUtil(final String spName, final int mode) {
        sp = getApplication().getSharedPreferences(spName, mode);
    }
     ...
     * @param t
     */
    public static <T> void putGsonStr(String objKey, @NonNull T t) {
        ...
        if (!StringUtils.isEmpty(jsonStr)) {
            getInstance().put(objKey, jsonStr);
        }
    }

    public static <T> T getGsonObject(String objKey, Class<T> claz) {
        Gson gson = new GsonBuilder()
                .enableComplexMapKeySerialization()
                .create();
        String gsonStr = getInstance().getString(objKey);
